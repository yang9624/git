...
!function(e, t) {
  ...
  return function(e) {
        ...
        x = function() {
          ...
          e.prototype.importContext = function(e) {
            var t = this,
              ...
              p = u.imports,
              l = this.CONTEXT_MAP;
            y(l, e) || -1 !== o.indexOf(e) || (y(r, e)
              ? (n = r[e], y(i, e) && i[e].forEach(function(e) {
                return t.importContext(e)
              }))
              : n = "$escape" === e || "$each" === e || y(p, e)
                ? a + "." + e
                : s + "." + e, l[e] = n, c.push({name: e, value: n}))
          },
          ...
          e.prototype.build = function() {
            ...
            e.compileDebug
              ? (r.push("try{"), n.forEach(function(e) {
    ...
    function(e, t, n) {
      ...
      var i = function(e, t) {
        for (var n = arguments.length > 2 && arguments[2] !== undefined
          ? arguments[2]
          : {}, i = [
          {
            type: "string",
          ...
          !function(e) {
            for (var t = e.test.ignoreCase
              ? "ig"
              : "g", o = e.test.source + "|^$|[\\w\\W]", s = new RegExp(o, t), a = 0; a < i.length; a++)
              if ("string" === i[a].type) {
        ...
        use: function(e, t, n, i) {
          ...
          switch ("#" === t && h("#value", "@value"), f) {
            ...
            case "else":
              var m = c.indexOf("if");
              ~m
                ? (c.splice(0, m + 1), i = "}else if(" + c.join("").trim() + "){")
                : i = "}else{";
              break;
            case "/if":
              i = "}";
            ...
            default:
              if (~ c.indexOf("|")) {
                var d = a.reduce(function(e, t) {
                  ...
                  return "|" === n
                    ? e.push([])
                    : "whitespace" !== r && "comment" !== r && (e.length || e.push([]), ":" === n && 1 === e[e.length - 1].length
